...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset_name", default="visa", help="Dataset name used for class prompts.")
    parser.add_argument("--checkpoint", default="checkpoints_visa_clip_img_encoder/model_epoch_10.pth")
    parser.add_argument("--checkpoint-args", default=None, help="Optional args.json path for model settings.")
    parser.add_argument("--device", default="cuda:1")
    parser.add_argument("--output-dir", default="prompt_patch_attention_vis_clip_baseline")
...
def main() -> None:
    ...
    text_encoder = CLIPTextEncoder(args.model_id, device=args.device)
